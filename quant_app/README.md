...
* **Propósito Académico**: Desarrollado con fines educativos para el **Taller de Finanzas Cuantitativas** en la **Pontificia Universidad Javeriana de Cali - Colombia**.
* **Fundamento Teórico y Metodológico**: Basado en código desarrollado a lo largo de la trayectoria profesional y formación académica del autor, y en las teorías financieras y libros utilizados en la **Maestría de Data Science, Big Data e AI de la Universidad Complutense de Madrid**.
* **Sitio Web Académico y Recursos**: [Rodney Menezes](https://sites.google.com/view/rodney-menezes).
